...
class UserController extends Controller
{
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        return redirect()->route('usuarios.index')
            ->with('mensaje', 'Registro ' . $registro->name . ' actualizado satisfactoriamente.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('usuarios.index')
            ->with('mensaje', $registro->name . ' eliminado satisfactoriamente.');
    }
    ...
    public function toggleStatus(User $usuario)
    {
        ...
        return redirect()->route('usuarios.index')
            ->with('mensaje', 'El estado del usuario fue actualizado satisfactoriamente.');
    }
}